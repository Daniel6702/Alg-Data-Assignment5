...
class Graph {
  ...
  public:
	...
	void dijkstra_bzz(int s, vector<int>& path, vector<int>& dist);
	void new_dijkstra(int start, int goal,vector<int>& path, vector<int>& dist);
	void a_star(int start, int goal, vector<int>& path, vector<int>& dist);
